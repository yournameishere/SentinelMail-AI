...
export function Hero() {
  return (
    <section className="relative flex min-h-dvh items-center overflow-hidden bg-background px-4 pb-16 pt-28 text-black md:px-8 md:pt-32">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-12 lg:grid-cols-[minmax(0,1fr)_460px]">
        <motion.div
          ...
          className="max-w-4xl"
        >
          <h1 className="font-serif text-6xl font-black uppercase leading-[0.9] text-black sm:text-7xl md:text-8xl lg:text-9xl">
            SentinelMail AI
          </h1>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/dashboard"
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-black px-6 font-mono text-xs uppercase text-[#FF4D00] transition-colors hover:bg-[#FF4D00] hover:text-black"
            >
              Open dashboard
            ...
            <Link
              href="/approvals"
              className="inline-flex min-h-12 items-center justify-center rounded-full border border-black px-6 font-mono text-xs uppercase text-black transition-colors hover:bg-black hover:text-[#FF4D00]"
            >
              Review approvals
            </Link>
          </div>
        ...
        <motion.div
          ...
          className="relative border-y border-black py-5"
